...
# Requirements
The default minifier shells out to the `html-minifier` CLI, which must be
installed and on your `PATH` (e.g. `npm install -g html-minifier`). On Windows
the npm `.cmd` shim is resolved automatically.
